...
class CarDealer(models.Model):
    ...
    phone = models.CharField(validators=[MinLengthValidator(11), MaxLengthValidator(11)], max_length=11)
    location = models.ForeignKey(Location, on_delete=models.CASCADE, default = "")  # Change to ForeignKey
